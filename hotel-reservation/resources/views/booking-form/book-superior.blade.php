...
<head>
    <meta charset="utf-8">
    <title>Superior Room | TheHaven</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Experience luxury in our Superior Room with premium amenities and stunning views">
...
<body>
    ...
    @include('nav')
        ...
        <div class="booking-container d-lg-flex">
            ...
            <div class="col-lg-6">
                <div class="image-container">
                    ...
                    <div class="image-overlay">
                        ...
                        <h2 class="room-title">Superior Room</h2>
                        ...
                        <div class="mt-3">
                            ...
                            <span class="badge bg-light text-dark me-2"><i class="fas fa-bed amenity-icon"></i> Twin Beds</span>
                            <span class="badge bg-light text-dark me-2"><i class="fas fa-snowflake amenity-icon"></i> Air Conditioning</span>
                            <span class="badge bg-light text-dark"><i class="fas fa-coffee amenity-icon"></i> Coffee & Tea Maker</span>
                        </div>
                        </div>
            ...
            <!-- Booking Form -->
            @include('components.booking-form', ['roomType' => 'Superior', 'ratePerNight' => 3800])
        </div>
    </div>


            <!-- Payment Receipt Section (Initially Hidden) -->
            @include('modal', ['room_type' => 'Superior'])
        </div>
        </div>
    </div>
    </div>
