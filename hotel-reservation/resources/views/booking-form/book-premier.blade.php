...
<body>
    ...
    @include('nav')
        ...
        <div class="booking-container d-lg-flex">
            ...
            <div class="col-lg-6">
                <div class="image-container">
                    ...
                    <div class="image-overlay">
                        ...
                        <h2 class="room-title">Premier Room</h2>
                        ...
                        <div class="mt-3">
                            ...
                            <span class="badge bg-light text-dark"><i class="fas fa-user-lock amenity-icon"></i> In-Room Safe</span>
                            <span class="badge bg-light text-dark me-2"><i class="fas fa-bed amenity-icon"></i> King Bed + Sofa Bed</span>
                            <span class="badge bg-light text-dark me-2"><i class="fas fa-snowflake amenity-icon"></i> Air Conditioning</span>
                            <span class="badge bg-light text-dark"><i class="fas fa-tshirt amenity-icon"></i> Bathrobe</span>
                        </div>
                        </div>
            ...
            <!-- Booking Form -->
            @include('components.booking-form', ['roomType' => 'Premier', 'ratePerNight' => 4500])
        </div>
    </div>


            <!-- Payment Receipt Section (Initially Hidden) -->
            @include('modal', ['room_type' => 'Premier'])
        </div>
        </div>
    </div>
    </div>
