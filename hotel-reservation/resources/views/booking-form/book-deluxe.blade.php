...
<body>
    ...
    @include('nav')
        ...
        <div class="booking-container d-lg-flex">
                ...
                <div class="image-container">
                    ...
                    <div class="image-overlay">
                        ...
                        <div class="mt-3">
                            ...
                            <span class="badge bg-light text-dark me-2"><i class="fas fa-tv amenity-icon"></i> Flatscreen TV</span>
                            <span class="badge bg-light text-dark"><i class="fas fa-shower amenity-icon"></i> Hot & Cold Shower</span>
                                                        <span class="badge bg-light text-dark me-2"><i class="fas fa-bed amenity-icon"></i> Queen Bed</span>
                            <span class="badge bg-light text-dark me-2"><i class="fas fa-snowflake amenity-icon"></i> Air Conditioning</span>
                            <span class="badge bg-light text-dark"><i class="fas fa-wine-bottle amenity-icon"></i> Mini Bar</span>
                        </div>
                        </div>
            ...
            <!-- Booking Form -->
            @include('components.booking-form', ['roomType' => 'Deluxe', 'ratePerNight' => 3200])
            @include('modal', ['room_type' => 'Deluxe'])
        </div>
    </div>
