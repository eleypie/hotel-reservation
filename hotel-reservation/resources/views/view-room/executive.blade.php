...
<body>
    ...
    <section class="full-page-section">
            ...
            <div id="mainCarousel" class="carousel slide h-100" data-bs-ride="carousel">
                <div class="carousel-inner h-100">
                    <div class="carousel-item active h-100">
                        <img src="../images/executive-2.jpg" class="d-block w-100" alt="Executive Suite">
                    </div>
                    <div class="carousel-item h-100">
                        <img src="../images/executive-1.jpg" class="d-block w-100" alt="Bathroom">
                    </div>
                    <div class="carousel-item h-100">
                        <img src="../images/executive-3.jpg" class="d-block w-100" alt="City View">
                    </div>
                </div>
                ...
                <div id="carousel-thumbs" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row gx-2">
                                <div class="col-4">
                                    <img src="../images/executive-2.jpg" class="d-block w-100 selected" data-bs-target="#mainCarousel" data-bs-slide-to="0" alt="Thumbnail 1">
                                </div>
                                <div class="col-4">
                                    <img src="../images/executive-1.jpg" class="d-block w-100" data-bs-target="#mainCarousel" data-bs-slide-to="1" alt="Thumbnail 2">
                                </div>
                                <div class="col-4">
                                    <img src="../images/executive-3.jpg" class="d-block w-100" data-bs-target="#mainCarousel" data-bs-slide-to="2" alt="Thumbnail 3">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="details-column">
            <h1 class="room-title">Executive Suite</h1>
