            ...
            <div id="mainCarousel" class="carousel slide h-100" data-bs-ride="carousel">
                <div class="carousel-inner h-100">
                    <div class="carousel-item active h-100">
                        <img src="../images/honeymoon-3.jpg" class="d-block w-100" alt="Honeymoon Suite">
                    </div>
                    <div class="carousel-item h-100">
                        <img src="../images/honeymoon-1.jpg" class="d-block w-100" alt="Bathroom">
                    </div>
                    <div class="carousel-item h-100">
                        <img src="../images/honeymoon-2.jpg" class="d-block w-100" alt="City View">
                    </div>
                </div>
                ...
                <div id="carousel-thumbs" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row gx-2">
                                <div class="col-4">
                                    <img src="../images/honeymoon-3.jpg" class="d-block w-100 selected" data-bs-target="#mainCarousel" data-bs-slide-to="0" alt="Thumbnail 1">
                                </div>
                                <div class="col-4">
                                    <img src="../images/honeymoon-1.jpg" class="d-block w-100" data-bs-target="#mainCarousel" data-bs-slide-to="1" alt="Thumbnail 2">
                                </div>
                                <div class="col-4">
                                    <img src="../images/honeymoon-2.jpg" class="d-block w-100" data-bs-target="#mainCarousel" data-bs-slide-to="2" alt="Thumbnail 3">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="details-column">
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    ...
                    <div class="amenity-item">
                        <i class="fa fa-bath amenity-icon"></i>
                        <span>Jacuzzi</span>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="amenity-item">
                        <i class="fab fa-microsoft amenity-icon"></i>
                        <span>Balcony</span>
                    </div>
                </div>
            </div>
            ...
            <div class="price-section mt-4">
                <a href="{{ route('booking-honeymoon') }}" style="text-decoration: none;">
                    
                    <div class="price-amount">₱8,200 <span class="text-muted">/ night</span></div>
