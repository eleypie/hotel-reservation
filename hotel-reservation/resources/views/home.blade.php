                ...
                <div class="map-section">
                    <div class="map-container">
                        ...
                        <div class="map-overlay-controls">
                            <button class="map-control-btn zoom-in" onclick="alert('Zoom functionality would be implemented with Maps API')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#1a365d" viewBox="0 -960 960 960">
                                    <path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580t75.5-184.5T380-840t184.5 75.5T640-580q0 44-14 83t-38 69l252 252zM380-400q75 0 127.5-52.5T560-580t-52.5-127.5T380-760t-127.5 52.5T200-580t52.5 127.5T380-400m-40-60v-80h-80v-80h80v-80h80v80h80v80h-80v80z"/>
                                </svg>                                       
                            </button>
                            <button class="map-control-btn zoom-out" onclick="alert('Zoom functionality would be implemented with Maps API')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#1a365d" viewBox="0 -960 960 960">
                                    <path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580t75.5-184.5T380-840t184.5 75.5T640-580q0 44-14 83t-38 69l252 252zM380-400q75 0 127.5-52.5T560-580t-52.5-127.5T380-760t-127.5 52.5T200-580t52.5 127.5T380-400M280-540v-80h200v80z"/>
                                </svg>
                            </button>
                            <button class="map-control-btn locate" onclick="alert('Location functionality would be implemented with Geolocation API')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#1a365d" viewBox="0 -960 960 960">
                                    <path d="M440-42v-80q-125-14-214.5-103.5T122-440H42v-80h80q14-125 103.5-214.5T440-838v-80h80v80q125 14 214.5 103.5T838-520h80v80h-80q-14 125-103.5 214.5T520-122v80zm40-158q116 0 198-82t82-198-82-198-198-82-198 82-82 198 82 198 198 82m0-120q-66 0-113-47t-47-113 47-113 113-47 113 47 47 113-47 113-113 47m0-80q33 0 56.5-23.5T560-480t-23.5-56.5T480-560t-56.5 23.5T400-480t23.5 56.5T480-400m0-80"/>
                                </svg>
                            </button>
                        </div>
                        ...
                        <div class="contact-info-box">
                            <div class="info-item">
                                ...
                                <div>
                                    <h5>Our Location</h5>
                                    <p>350 5th Avenue<br>New York, NY 10118</p>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <div>
                                    <h5>Call Us</h5>
                                    <p>+1 (212) 736-3100<br>Mon-Fri, 9am-5pm</p>
                                </div>
                            </div>
                        </div>
                    </div>
